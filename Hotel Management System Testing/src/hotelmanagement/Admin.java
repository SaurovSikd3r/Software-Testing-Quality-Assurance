...
public class Admin {
    private static Map<Integer, String> policies = new HashMap<>(); // Stores policies with their IDs
    private static int policyCounter = 1;
    private static List<String> systemLogs = new ArrayList<>(); // Simulates system logs
    private static Map<String, String> userRoles = new HashMap<>(); // Stores user roles (username -> role)
    private static Map<String, String> hotelPreferences = new HashMap<>(); // Stores hotel preferences
